        ...
        <div class="content">
          ...
          <div class="button-row">
            ...
            <a
              ...
              href="https://wa.link/assetarconsultation"
              target="_blank"
              style="text-decoration: none"
            >
...
main {
    ...
    .text-section {
      ...
      .notif {
        ...
        p {
          ...
          color: var(--Grey-2, #5d6162);
        }
      }
      .intro-text {
        color: var(--Grey-1, #2e2f35);
  ...
  .btm-talk {
    width: 100%;
    // height: 10rem;
    background: linear-gradient(to bottom, #050410 50%, #fff 50%);
    .content {
